...
class Group {
    ...
    public function toXML(
        ...
        if ($methodName === 'createGroup') {
            ...
            if (!empty($this->getOldName())) {
                $identifier->addChild('Name', $this->getOldName());
            } else if (!empty($this->getOldGroupId())) {
                $identifier->addChild('GroupID', $this->getOldGroupId());
            } else {
                ...
                $identifier->addChild('Name', $this->getName());
            }
            $group = $parameters->addChild('Group');
            if (!empty($this->getOldName())) {
                $group->addChild('Name', $this->getName());
            ...
            if (!empty($this->getOldGroupId())) {
                $group->addChild('GroupID', $this->getGroupId());
                $this->setOldGroupId(null);
            }
            ...
            if (!empty($this->getHomeGroupMessage())) {
                $group->addChild('HomeGroupMessage', $this->getHomeGroupMessage());
            }
            if (!empty($this->getNotificationEmails())) {
                $notificationEmails = $group->addChild('NotificationEmails');
                foreach ($this->getNotificationEmails() as $email) {
                    $notificationEmails->addChild('NotificationEmail', $email);
                }
        ...
        foreach ($this->getUsers() as $user) {
            ...
            if ($methodName === 'updateGroup') {
                $userTag->addChild('UserAction', $user->getAction());
            }
        ...
        if (!empty($this->getSubscriptionVariants()) || $methodName === 'updateGroup') {
