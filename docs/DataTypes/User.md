...
|[getGroups](#usergetgroups)|Get the container for assigning groups to the user and specifying the user's permissions within those groups.|
...
|[setGroups](#usersetgroups)|Set the container for assigning groups to the user and specifying the user's permissions within those groups.|
...
|[toXML](#usertoxml)|Generate an XML representation of the user, to be passed into the API for a CreateUser or UpdateUser query.|
...
Get the container for assigning groups to the user and specifying the user's permissions within those groups. 
...
Set the container for assigning groups to the user and specifying the user's permissions within those groups. 
...
Generate an XML representation of the user, to be passed into the API for a CreateUser or UpdateUser query. 
